 ...
 * @method void modal(string $file, array $data = null, string $key = null) Renders modal
 * @method void script(string $file, array $data = null, string $key = null) Renders script
...
class Engine {
    ...
    public function init() {
        ...
        $methods = array(
            ...
            'render','modal','script','redirect','etag','lastModified','json','jsonp'
        );
     ...
     * @throws \Exception
     */
    public function _modal($file, $data = null, $key = null) {
        if ($key !== null) {
            $this->view()->set($key, $this->view()->fetch($file, $data));
        }
        else {
            $this->view()->modal($file, $data);
        }
    }
     ...
     * @throws \Exception
     */
    public function _script($file, $data = null, $key = null) {
        if ($key !== null) {
            $this->view()->set($key, $this->view()->fetch($file, $data));
        }
        else {
            $this->view()->script($file, $data);
        }
    }
